...
export default function CotizacionesView() {
    ...
    const buscarCotizaciones = async () => {
        const res = await fetch(`http://localhost:5000/api/ia/cotizaciones?clienteId=${clienteSeleccionado}`)
        const data = await res.json()
        setCotizaciones(data)
    }

    const cargarCotizacion = async (id) => {
        const res = await fetch(`http://localhost:5000/api/ia/cotizaciones/${id}`)
        const data = await res.json()
    ...
    const guardar = async () => {
        ...
        const res = await fetch(`http://localhost:5000/api/ia/cotizaciones/${seleccionada.id}`, {
            method: 'PUT',
